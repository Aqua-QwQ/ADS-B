...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_head_0 = blocks.head(gr.sizeof_float*1, 256)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'C:\\gnuradio_test\\tx_samples.dat', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'C:\\gnuradio_test\\rx_samples_snr0.dat', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 1.0, 0)
